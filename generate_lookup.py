...
if __name__ == '__main__':
    ...
    L1 = np.zeros((5, 7))
    L2 = np.zeros((5,7))
    # table 0. correspond to not set values, everything else is needed or used as starting conditions #TODO fix maxcl3cd2 and use for minsink
    #        minsink         _p    max climb      crs     maxcr      maxsink_p     maxsink
    L1[0] = [  ldmax,     ldmax,       ldmax,    0.034906,    0.002,     ldmax,         0.]  # 0 alpha
    L1[1] = [  13.50000, 11.790514, 13.50000, 14.00000, 20.00000,  23.00000,   20.00000]  # 1 airspeed
    ...
    L2[0] = [  ldmax,     ldmax,       ldmax,    0.034906,    0.002,     ldmax,         0.]  # 0 alpha
    L2[1] = [  13.50000, 11.790514, 13.50000, 14.00000, 20.00000,  23.00000,   20.00000]  # 1 airspeed
